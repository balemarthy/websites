export default function TechnicalBrandingPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-bve-canvas px-6 py-32 text-center">
