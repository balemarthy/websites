...
// content yet, not a lesser effort. Blog content now lives in GHL
// (BLOG_URL) — once that link is real, any visitor who still lands on this
// route gets bounced straight there. While BLOG_URL is still the "#"
