...
// The exact shuffle state machine from the program stack cards, generalized
// over content: `order` is always a complete permutation of the 4 visible
// card ids — role is array position, by construction, so there's no
// separate "which card has role X" lookup that could fall out of sync.
// Reused as-is (unchanged mechanically) by every stack on the site —
// currently the program cards and testimonials.
